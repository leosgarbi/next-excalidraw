...
/**
 * Versão customizada do MainMenu do Excalidraw:
 * - Remove o link do X/Twitter (`SocialMedia`).
 * - Remove o link do GitHub (`Socials.Github`).
 * - Substitui o link do Discord pelo servidor do projeto.
 *
 * Estrutura padrão (Excalidraw 0.18.x):
 *   LoadScene, SaveAsImage, Help, ClearCanvas, ToggleTheme, ChangeCanvasBackground,
 *   Socials.Github, Socials.X, Socials.Discord, Hint
 *
 * Como `Socials` é namespace, montamos a lista manualmente com os defaults
 * desejados.
 */
