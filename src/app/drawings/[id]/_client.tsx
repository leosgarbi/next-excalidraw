...
const Excalidraw = dynamic(
  ...
  { ssr: false, loading: () => <div className="p-8 text-sm text-muted-foreground">Carregando…</div> },
);
...
export function DrawingPageClient({
  ...
  const initialData =
    drawing.content && typeof drawing.content === "object" ? (drawing.content as Record<string, unknown>) : {};
